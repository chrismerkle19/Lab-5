...
#Use strict redis
redis = StrictRedis(host="127.0.0.1", port=6379, charset="utf-8", decode_responses=True)
app = Flask(__name__)
...
def slackalert(message):
    ...
    requests.post('https://hooks.slack.com/services/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', body.encode('utf-8'), data=payload)
